...
### 🎓 Universidad 
Actualmente cursando materias fundamentales que van construyendo mi base técnica:

- **🔧 Ingeniería de Software** - *Metodologías, ciclo de vida del software y buenas prácticas*
  - 📂 [Ver documentación y proyectos →](https://github.com/KaruG1999/Ingenieria_de_Software1)

- **🐧 Sistemas Operativos** - *Entorno GNU/Linux Debian*
  - 📂 [Ver apuntes y prácticas →](https://github.com/KaruG1999/Intro_Sistemas_Operativos)

- **☕ Orientación a Objetos** - *Java con Eclipse IDE*
  - 📂 [Ver códigos y ejercicios →](https://github.com/KaruG1999/Orientaci-n_a_Objetos1)

### 💻 Curso Full Stack Development
Complementando mi formación universitaria con un enfoque más práctico y orientado al desarrollo web:

**Stack Tecnológico:**
- **Frontend:** HTML, CSS, TypeScript, Angular
- **Backend:** C#, .NET, Web API, ORM
- **Herramientas:** Git, GitHub, SQL
- **Principios:** Clean Code, Patrones de Diseño
...
<p align="left">
  <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/dot-net-colored.svg" width="30" height="30" alt=".NET" title=".NET" />
  <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/mysql-colored.svg" width="30" height="30" alt="SQL" title="SQL" /> 
</p>
-->
...
<p align="left">
  ...
  <!-- <img src="https://cdn.worldvectorlogo.com/logos/eclipse-11.svg" width="30" height="30" alt="Eclipse" title="Eclipse IDE" /> -->
</p>

<!-- ### Sistemas Operativos
<p align="left">
  <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/linux-colored.svg" width="30" height="30" alt="Linux" title="GNU/Linux" />
</p>
-->
...
<p align="center">
  <i>✨ Siempre en constante aprendizaje, buscando nuevos desafíos y oportunidades para crecer ✨</i>
</p>
